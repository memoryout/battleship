...
package org.puremvc.patterns.observer
{
	...
	public class Notifier
	{
		 ...
		 */ 
		public function sendNotification( notificationName:String, body:Object=null, type:String=null ):Notification 
		{
			var n:Notification = new Notification( notificationName, body, type );
			facade.notifyObservers( n );
			return n;
		}
